...
class TestEmbedText:
    def test_embed_text_returns_384_dim(self):
        ...
        with patch("myoutreach.linkedin.ml.embeddings._model", mock_model):
            from myoutreach.linkedin.ml.embeddings import embed_text
    ...
    def test_embed_texts_returns_batch(self):
        ...
        with patch("myoutreach.linkedin.ml.embeddings._model", mock_model):
            from myoutreach.linkedin.ml.embeddings import embed_texts
...
class TestLeadEmbeddingFields:
    ...
    def test_get_labeled_arrays_from_deals(self, fake_session):
        ...
        from myoutreach.crm.models import Deal, Lead, Outcome
