...
from myoutreach.core import scheduler
...
class TestWorkingSecondsInWindow:
    @patch("myoutreach.core.scheduler.ENABLE_ACTIVE_HOURS", False)
    ...
    @patch("myoutreach.core.scheduler.ENABLE_ACTIVE_HOURS", True)
    @patch("myoutreach.core.scheduler.ACTIVE_START_HOUR", 9)
    @patch("myoutreach.core.scheduler.ACTIVE_END_HOUR", 19)
    @patch("myoutreach.core.scheduler.ACTIVE_TIMEZONE", "UTC")
...
class TestPlanCheckPendingWindow:
    ...
    @patch("myoutreach.core.scheduler.ENABLE_ACTIVE_HOURS", False)
    @patch("myoutreach.core.scheduler.CHECK_PENDING_DAILY_CAP", 4)
