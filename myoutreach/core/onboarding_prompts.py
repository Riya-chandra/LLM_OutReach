...
Vendored from the (retired) myoutreach-cli. Only the self-hosted profile
is kept — the cloud-only VPN questions and their geo lookups are dropped.
"""

from __future__ import annotations

from myoutreach.core.onboarding_wizard import (
    Autocomplete,
    Confirm,
    IntText,
    MultilineText,
...
LEGAL = Confirm(
    "legal_acceptance",
    "Do you accept the Legal Notice? (https://github.com/eracle/myoutreach/LEGAL_NOTICE.md)",
    default=False,
    required=True,
)
