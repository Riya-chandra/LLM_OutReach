...
class Command(BaseCommand):
    help = "Run the myoutreach daemon (onboard, validate, start task queue)."
    ...
    def handle(self, *args, **options):
        ...
        from myoutreach.core.daemon import run_daemon
        run_daemon(session)

    # -- Steps ---------------------------------------------------------------

    def _configure_logging(self, verbose: bool = False):
        from myoutreach.core.logging import configure_logging, print_banner
    ...
    def _ensure_db(self):
        ...
        from myoutreach.core.management.setup_crm import setup_crm
        setup_crm()

    def _ensure_onboarded(self):
        from myoutreach.core.onboarding import apply, collect_from_wizard, missing_keys
    ...
    def _create_session(self):
        from myoutreach.linkedin.browser.registry import get_first_active_profile, get_or_create_session
