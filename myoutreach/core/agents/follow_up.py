# myoutreach/core/agents/follow_up.py
...
from myoutreach.core.conf import PROMPTS_DIR
from myoutreach.core.llm import get_llm_model, run_agent_sync
...
def _load_recent_messages(deal, limit: int = RECENT_MESSAGES_WINDOW) -> list:
    ...
    from myoutreach.chat.models import ChatMessage
...
def run_follow_up_agent(session, deal) -> FollowUpDecision:
    ...
    """
    from myoutreach.linkedin.db.chat import sync_conversation
...
if __name__ == "__main__":
    ...
    from myoutreach.linkedin.browser.registry import cli_parser, cli_session
