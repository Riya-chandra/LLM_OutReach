...
DEFAULT_PRODUCT_DOCS = ROOT_DIR / "docs" / "default_product_docs.md"
...
def missing_keys() -> set[str]:
    ...
    from myoutreach.core.models import Campaign, SiteConfig
...
def collect_from_wizard() -> OnboardConfig:
    ...
    """
    from myoutreach.core.onboarding_prompts import SELF_HOSTED_QUESTIONS
    from myoutreach.core.onboarding_wizard import ask
...
def _create_seed_leads(campaign, seed_urls: str) -> None:
    ...
    if not seed_urls or not seed_urls.strip():
        return
    from myoutreach.linkedin.setup.seeds import parse_seed_urls, create_seed_leads
...
def apply(config: OnboardConfig) -> None:
    ...
    from myoutreach.core.management.setup_crm import DEFAULT_CAMPAIGN_NAME
    from myoutreach.core.models import Campaign
    from myoutreach.linkedin.models import LinkedInProfile
    ...
    if config.legal_acceptance:
        from myoutreach.linkedin.models import LinkedInProfile as LP
