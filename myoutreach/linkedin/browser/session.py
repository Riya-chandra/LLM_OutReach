# myoutreach/linkedin/browser/session.py
...
from myoutreach.core.conf import MIN_DELAY, MAX_DELAY
...
class AccountSession:
    ...
    def campaigns(self):
        ...
        return list(Campaign.objects.filter(users=self.django_user, is_freemium=False))

    def ensure_browser(self):
        """Launch or recover browser + login if needed. Call before using .page"""
        from myoutreach.linkedin.browser.launch import start_browser_session
    ...
    def self_profile(self) -> dict:
        ...
        from myoutreach.linkedin.db.leads import register_self_lead
