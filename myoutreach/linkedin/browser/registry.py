# myoutreach/linkedin/browser/registry.py
...
def get_or_create_session(linkedin_profile) -> "AccountSession":
    from myoutreach.linkedin.browser.session import AccountSession
...
def cli_parser(description: str):
    ...
    os.environ.setdefault("DJANGO_SETTINGS_MODULE", "myoutreach.settings")

    import django
    django.setup()

    from myoutreach.core.logging import configure_logging
